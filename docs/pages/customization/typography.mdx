...
The typography tokens are available as Tailwind utility classes and are registered via the `@edge/tokens/tailwind-preset`.

```ts
import { fontFamily, fontSize, fontWeight } from '@edge/tokens'
```
